...
import antismash.detection.gut_hmm_detection as core
from antismash.detection.gut_hmm_detection import signatures
...
class HmmDetectionTest(unittest.TestCase):
    ...
    def test_profiles_parsing(self):
        ...
        assert len(profiles) == 249  # ensures we don't delete any by accident
